...
| Original fixture parity harness | `__tests__/extraction.test.ts`, `__tests__/resolution.test.ts`, `__tests__/frameworks*.test.ts` | `crates/codegraph/tests/` | Planned | [2026-05-17T000004](../issues/2026-05-17T000004-enhance-add-original-fixture-test-harness.md) | Use Rust fixtures and temp project indexing, not the TypeScript runner. |
| Extractor registry structure | `src/extraction/languages/index.ts`, `src/extraction/tree-sitter-types.ts` | `crates/codegraph/src/extraction.rs` or `crates/codegraph/src/extraction/**` | Planned | [2026-05-17T000005](../issues/2026-05-17T000005-enhance-improve-language-extractor-registry.md) | Refactor support before adding many language-specific ports. |
| TypeScript and JavaScript extraction | `src/extraction/languages/typescript.ts`, `src/extraction/languages/javascript.ts`, `__tests__/extraction.test.ts` | `crates/codegraph/src/extraction*`, `crates/codegraph/tests/` | Partial | [2026-05-17T000006](../issues/2026-05-17T000006-enhance-port-typescript-javascript-extraction.md) | Rust has generic regex extraction; full import/export/component coverage is planned. |
| Python extraction | `src/extraction/languages/python.ts`, `__tests__/extraction.test.ts` | `crates/codegraph/src/extraction*`, `crates/codegraph/tests/` | Partial | [2026-05-17T000007](../issues/2026-05-17T000007-enhance-port-python-extraction.md) | Rust has generic extraction; decorator and import fidelity is planned. |
| Go extraction | `src/extraction/languages/go.ts`, `__tests__/extraction.test.ts` | `crates/codegraph/src/extraction*`, `crates/codegraph/tests/` | Planned | [2026-05-17T000008](../issues/2026-05-17T000008-enhance-port-go-extraction.md) | Receiver methods and grouped imports remain unported. |
