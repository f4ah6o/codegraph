...
| Java and Kotlin extraction | `src/extraction/languages/java.ts`, `src/extraction/languages/kotlin.ts`, `__tests__/extraction.test.ts` | `crates/codegraph/src/extraction*`, `crates/codegraph/tests/` | Done | [2026-05-17T000009](../issues/closed/2026-05-17T000009-enhance-port-java-kotlin-extraction.md) | Dedicated Java/Kotlin extraction covers classes, interfaces, methods, Kotlin functions, imports, inheritance refs, annotations, and Kotlin suspend metadata. |
| C# extraction | `src/extraction/languages/csharp.ts`, `__tests__/extraction.test.ts` | `crates/codegraph/src/extraction*`, `crates/codegraph/tests/` | Done | [2026-05-17T000010](../issues/closed/2026-05-17T000010-enhance-port-csharp-extraction.md) | Dedicated C# extraction covers classes, interfaces, structs, enums, methods, properties, usings, attributes, inheritance refs, and async/static metadata. |
